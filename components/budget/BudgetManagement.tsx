                ...
                <CardHeader>
                  <div className="flex justify-between items-start gap-3">
                    <div>
                      ...
                      <CardDescription className="capitalize">{selectedBudget.type} Budget</CardDescription>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        {selectedBudget.subBudgets.map(sb => {
                          const percentage = sb.allocated > 0 ? (sb.spent / sb.allocated) * 100 : 0
                          return (
                            <div key={sb.id} className="space-y-2">
                              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
                                ...
                                <div className="flex flex-wrap items-center gap-2">
                                  <Input
                                    ...
                                    step="0.01"
                                    value={sb.allocated}
                                    onChange={e => handleUpdateSubBudgetAllocation(sb.id, e.target.value)}
                                    className="w-full sm:w-24"
                                  />
                                  <span className="text-sm text-muted-foreground whitespace-nowrap">
                                    {formatCurrency(sb.spent)} spent
                                  </span>
                                  <Button variant="ghost" size="sm" onClick={() => handleRemoveSubBudget(sb.id)}>
                              ...
                              <div className="flex justify-between text-xs text-muted-foreground">
                                <span>{formatCurrency(sb.allocated - sb.spent)} remaining</span>
                                <span>{percentage.toFixed(0)}%</span>
                              </div>
                            </div>
                          )
