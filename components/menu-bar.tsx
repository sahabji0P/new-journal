...
export function MenuBar() {
  ...
  return (
    <motion.nav
      className="p-3 rounded-3xl bg-gradient-to-b from-background/90 to-background/60 backdrop-blur-lg border border-border/50 shadow-2xl relative overflow-hidden max-w-fit mx-auto"
      initial="initial"
      whileHover="hover"
    >
      <motion.div
